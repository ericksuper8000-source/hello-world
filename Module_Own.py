...
Any_Iterable = any(num % 2 == 0 for num in Lista_Numeros)
Lista_Iterable = [num for num in Lista_Numeros if num % 2 == 0]
...
Flotante3 = input(f'Ingrese una operacion tipo 4*3: ')
